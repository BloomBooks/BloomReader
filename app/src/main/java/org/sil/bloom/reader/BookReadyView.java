...
public class BookReadyView extends ConstraintLayout {
    ...
    private final DownloadsView mDownloadsView;
    ...
    private void initializeViews(Context context) {
        ...
        mReadNowButton.setOnClickListener(view -> mDownloadsView.viewBooks(mBookPath));
        mMessage = this.findViewById(R.id.book_ready_message);
    ...
    private void updateMessage() {
        ...
        String label = getContext().getString("".equals(mBookPath) ? R.string.downloads_are_complete : R.string.download_is_complete);
        mMessage.setText(label);
        String buttonLabel = getContext().getString("".equals(mBookPath) ? R.string.view_books : R.string.read_now);
