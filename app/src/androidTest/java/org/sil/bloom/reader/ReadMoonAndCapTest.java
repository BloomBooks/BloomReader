...
public class ReadMoonAndCapTest {
    ...
    private void clickTheWrongAnswerToCQ1AndVerify() {
        ...
        onWebView()
                .withElement(findElement(Locator.CSS_SELECTOR, incorrectCheckboxSelector))
                .perform(webClick())
                .check(webMatches(script("return document.querySelector('" + incorrectCheckboxSelector + "').checked", castOrDie(Boolean.class)), is(false)));
    }
    ...
    private void clickTheRightAnswerToCQ1AndVerify() {
        ...
        onWebView()
                .withElement(findElement(Locator.CSS_SELECTOR, correctCheckboxSelector))
                .perform(webClick())
                .check(webMatches(script("return document.querySelector('" + correctCheckboxSelector + "').checked", castOrDie(Boolean.class)), is(true)));
    }
}