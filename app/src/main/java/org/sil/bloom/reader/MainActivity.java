...
//    }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_get_wifi) {
            ...
            if (!processDeviceIdInfoClick()) {
                // If we haven't handled the click, don't close the drawer
                return true;
            }
        }
    ...
    private boolean processDeviceIdInfoClick() {
        if (++mChangeDeviceIdForStatsClickCounter >= 3) {
            ...
            deviceInfoDialogFragment.show(getFragmentManager(), DeviceInfoDialogFragment.DEVICE_INFO_DIALOG_FRAGMENT_TAG);
            return true;
        }
        return false;
    }
