...
public class ReaderWebViewClient extends WebViewClient {
    ...
    public ReaderWebViewClient(String allowedPathPrefix, BloomFileReader fileReader) {
        ...
        // The canonical path does not have the file:// prefix, so we subtract that,
        // but we do need to strip off one more slash.
        mLengthOfCanonicalPrefix = allowedPathPrefix.length() - "file://".length() + 1;
    }
