...
//        setSupportActionBar(toolbar);
    ...
    private class BookPagerAdapter extends PagerAdapter {
        ...
        BookPagerAdapter(List<String> pages, ReaderActivity parent, File bookHtmlPath, String startFrame, String endFrame, String folderPath) {
            mPages = pages;
            mParent = parent;
        ...
        @Override
        public int getCount() {
            //Log.d("Reader", "getCount = "+ mPages.size());
            return mPages.size();
        }
        ...
        public Object instantiateItem(ViewGroup container, int position) {
            ...
            synchronized (this) {
                needToGetNextPage = mNextPageIndex != position + 1 && position < mPages.size() - 1;
            }
        ...
        private WebView MakeBrowserForPage(int position) {
            ...
            try {
                ...
                String doc = mStartFrame + page + mEndFrame;
