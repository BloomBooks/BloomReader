...
//        });
        ...
        try {
            ...
            final String url = "file:///android_asset/bloom-player/bloomplayer.htm?url=file:///"
                    + bookHtmlFile.getAbsolutePath()+"&showBackButton=true&allowToggleAppBar=true"
                    + "&initiallyShowAppBar=false&centerVertically=true&hideFullScreenButton=true"
                    + "&initiallyReadImageDescriptions=true&independent=false&host=bloomreader";
