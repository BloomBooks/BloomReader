...
public class BloomLibraryWebViewClient extends WebViewClient {
    ...
    public WebResourceResponse shouldInterceptRequest(WebView view, WebResourceRequest request) {
        ...
        // We need to do this if we reading the original stream into data.content.
        ...
        // However, default behavior won't work for parse.com requests, unless we remove the code
